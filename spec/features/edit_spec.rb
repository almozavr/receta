...
feature 'Creating, editing, and deleting a recipe', js: true do
  scenario 'should CRUD a recipe' do
    visit '/'
    click_on 'New Recipe…'

    fill_in "name", with: "Baked Brussel Sprouts"
    fill_in "instruction", with: "Slather in oil, then bake for 20 minutes"
    ...
    fill_in "instruction", with: "Slather in oil, then roast for 20 minutes"
